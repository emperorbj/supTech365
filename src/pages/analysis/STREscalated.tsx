...
export default function STREscalated() {
  const breadcrumbItems = [
    { label: "Analysis Workspace", icon: <TrendingUp className="h-5 w-5" /> },
    { label: "STR Review Queue", link: "/analysis/str-review" },
    { label: "Escalated CTRs" },
  ];
      ...
      <div className="p-6 space-y-6">
        <div className="flex items-center justify-between">
          <h1 className="text-2xl font-semibold flex items-center gap-2">
            ...
            Escalated CTRs for Analysis ({mockEscalatedCTRs.length} items)
          </h1>
        ...
        <Card>
          <CardContent className="p-4">
            <p className="text-sm text-muted-foreground">
              Note: These are CTRs escalated by Compliance Officers for further investigation by the Analysis team.
            </p>
          </CardContent>
        </Card>

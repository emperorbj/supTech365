...
export default function CTREscalated() {
  ...
  const { data, isLoading, error, refetch } = useEscalatedReports(page, pageSize, { report_type: "CTR" });
        ...
        <div className="p-6">
          <Card className="border-destructive">
            <CardContent className="p-6 text-center">
              <p className="text-destructive font-medium">Failed to load escalated reports</p>
      ...
      <div className="p-6 space-y-6">
        <div className="flex items-center justify-between">
          <h1 className="text-2xl font-semibold flex items-center gap-2">
            ...
            Escalated CTRs ({data?.total || 0} items)
          </h1>
          ...
          <CardContent className="p-0">
            {isLoading ? (
              <div className="p-12 text-center">
                ...
                <p className="mt-4 text-muted-foreground">Loading escalated reports...</p>
              </div>
            ) : (
              <Table>
                <TableHeader>
